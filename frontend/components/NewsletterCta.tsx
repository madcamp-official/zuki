...
export default function NewsletterCta() {
  return (
    <section className="relative flex flex-col items-center gap-3 overflow-visible rounded-[24px] bg-gradient-to-r from-[#8a3d1f] via-strawberry to-[#d98a5f] px-6 py-6 text-center text-white sm:flex-row sm:pr-48 sm:text-left">
