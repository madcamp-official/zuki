export default function NewsletterCta() {
  return (
    <section className="relative flex flex-col items-center gap-3 overflow-hidden rounded-[24px] bg-gradient-to-r from-[#d80e19] via-strawberry to-[#ef5a4d] px-6 py-6 text-center text-white sm:flex-row sm:text-left">
      ...
      <form className="flex w-full flex-col gap-2 sm:ml-auto sm:max-w-xl sm:flex-row">
        <input
          type="email"
